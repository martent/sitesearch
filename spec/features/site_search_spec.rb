...
describe "SiteSearch" do
  ...
  describe "results" do
    ...
    it "should have results with linked headings" do
      expect(page).to have_selector(".results > ol > li:first-child  h2 a")
    end

    it "should have a results entry with extracts" do
      expect(page).to have_selector(".results > ol > li:first-child .extract")
    end

    it "should have a results entry with a category" do
      expect(page).to have_selector(".results > ol > li:first-child .category")
    end
